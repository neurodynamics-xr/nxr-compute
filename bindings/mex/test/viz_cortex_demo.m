...
% planes on a folded cortex — inspect that one in the 3-D viewer.
snap3(nxr.viz.vectorField(V, F, M.solve.hodge.omegaVectors, ...
      'Title', 'Hodge omega — input 1-form (face)', vopt{:}), ...
      outdir, 'omega.png');
...
fprintf('  analyses:   poisson, gradient, hodge_exact, hodge_coexact, omega, trivial, geodesic_path\n');
