...
vopt = {'Scale', 3, 'NMax', 1500};   % arrow length + subsample for vector fields
...
M.solve.poisson          = nxr.manifold.solve.poisson(ctx, [1 10000], [1 -1]);
...
snap3(nxr.viz.scalar(V, F, M.solve.poisson, 'Title', 'poisson \phi (two sources)'), ...
      outdir, 'poisson.png');
