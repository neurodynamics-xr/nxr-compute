 ...
 *   2. solveEigenmodes increments the iteration counter monotonically.
...
void test_DefaultObserverIsNoOp() {
    ...
    nxr::compute::ProgressObserver obs;  // all slots null
...
void test_ObserverWritesAtomicSlots() {
    ...
    nxr::compute::ProgressObserver obs;
    obs.iteration = &iter;
...
void test_SolveEigenmodesUpdatesProgress() {
    std::cout << "[4] solveEigenmodes ticks the iteration counter" << std::endl;
